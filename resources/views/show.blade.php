...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800 flex-col md:flex-row">
        <div class="container mx-auto px-4 py-16 flex">
            <img src="/img/parasite.jpg" alt="parasite" class="w-64  md:w-96" style="width: 24rem">
            <div class="md:ml-24">
                ...
                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquid asperiores consequatur debitis dignissimos, ex expedita facilis in molestias nihil optio quae quaerat quam quas recusandae sed sunt ut veritatis!
                </p>
    ...
    <div class="movie-scenes border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/image2.jpg" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>

                <div class="mt-8">
                    <a href="#">
                        <img src="/img/image3.jpg" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>

                <div class="mt-8">
                    <a href="#">
                        <img src="/img/image4.jpg" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>

                <div class="mt-8">
                    <a href="#">
                        <img src="/img/image5.jpg" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>

                <div class="mt-8">
                    <a href="#">
                        <img src="/img/image6.jpg" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
