    ...
    <div class="container mx-auto px-4">
        <div class="movie-info border-b border-gray-800 flex-col md:flex-row">
            <div class="container mx-auto px-4 py-16 flex">
                <img src="{{ $tv['poster_path'] }}" alt="tv-show" class="w-64 lg:w-96" style="width: 24rem">
                <div class="md:ml-24">
        ...
        <div class="movie-scenes border-b border-gray-800 mb-16" x-data="{ isOpen : false, image : '' }">
            <div class="container mx-auto px-4 py-16">
                <h2 class="text-4xl font-semibold">Scenes</h2>

                <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">

                    @foreach($tv['backdrops'] as $backdrop)
